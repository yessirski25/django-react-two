...
export default class CreateRoomPage extends Component {
    ...
    handleRoomButtonPressed() {
        ...
        axios.post(`${import.meta.env.VITE_API_URL}/api/create-room/`, requestData, {
    ...
    render () {
        return (
            <Grid container spacing={1}>
                ...
                <Grid item xs={12} align="center">
                    <FormControl>
                        <TextField variant="standard" required={true} type="number" defaultValue={this.defaultVotes} inputProps={{min: 1, style: { textAlign: "center"}}} onChange={this.handleVotesChange}/>
                        <FormHelperText>
